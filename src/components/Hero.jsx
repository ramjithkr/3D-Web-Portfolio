      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText}text-white`}>
            Hi, I&apos;m <span className="text-[#915eff]">Ramjith</span>
          </h1>
          <p className={`${styles.heroSubText}mt-2 text-white-100`}>
            I’m a full-stack MERN developer skilled in building efficient web
            applications using React, Node.js, and MongoDB. I focus on creating
